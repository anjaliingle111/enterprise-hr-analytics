-- Populate HR Tables Using Actual Column Structure
BEGIN;

-- Transform companies to departments first
...
-- Populate Performance Reviews (using actual columns)
...
-- Populate Employee Surveys (structure matches)
...
-- Populate Skills Matrix (without assessor_id since it doesn't exist)
...
-- Populate Leave Balances (structure matches perfectly)
...
SELECT 'Companies transformed and HR data populated with real structure!' as status;
